...
const ct = {
     ...
     */
    version: '1.7.0',
    meta: [{"name":"AstroidShooter","author":"Dak","site":"","version":"1.0.0"}][0],
    main: {
        fpstick: 0,
        pi: 0
    },
...
ct.inputs.addAction('MoveX', [{"code":"keyboard.ArrowRight","multiplier":1},{"code":"keyboard.ArrowLeft","multiplier":-1},{"code":"keyboard.KeyD"},{"code":"keyboard.KeyA","multiplier":-1}]);
ct.inputs.addAction('MoveY', [{"code":"keyboard.ArrowUp","multiplier":-1},{"code":"keyboard.ArrowDown","multiplier":1},{"code":"keyboard.KeyW","multiplier":-1},{"code":"keyboard.KeyS"}]);
ct.inputs.addAction('Shoot', [{"code":"mouse.Left"}]);
ct.inputs.addAction('ChangeScreen', [{"code":"keyboard.Space"}]);
...
ct.rooms.templates['MainRoom'] = {
    ...
    objects: JSON.parse('[{"x":448,"y":512,"exts":{},"type":"playership"}]'),
...
if(this.asteroidTimer <=  0){
    ...
    ct.types.copy(ct.random.dice('Asteroid_Medium', 'Asteroid_Big'), ct.random(ct.camera.width), -100);
}
...
if(this.enemyTimer <=  0){
    ...
    ct.types.copy(ct.random.dice('EnemyShip'), ct.random(ct.camera.width), -100);
}
    },
    onDraw() {
...
if(ct.actions.ChangeScreen.pressed){
    ...
    onCreate() {
        this.StartgameLabel = new PIXI.Text('Click space \r\n to start the game', ct.styles.get('LabelStyle'));
this.addChild(this.StartgameLabel);
this.StartgameLabel.x = 128;
this.StartgameLabel.y = 128;
this.StartgameLabel.depth = 5;
    },
    extends: {}
}
...
(function resAddon(ct) {
    ...
    ct.res = {
        ...
        soundsError: 0,
        sounds: {},
        registry: [{"playership":{"frames":1,"shape":{"type":"strip","points":[{"x":0,"y":-38},{"x":12.66666666666666,"y":-18.66666666666666},{"x":49.666666666666664,"y":0},{"x":55.33333333333333,"y":6.333333333333334},{"x":37.666666666666664,"y":34},{"x":16.666666666666668,"y":28.999999999999996},{"x":11.333333333333329,"y":35.333333333333336},{"x":-11.666666666666668,"y":36.00000000000001},{"x":-17.33333333333334,"y":28.33333333333334},{"x":-38.666666666666664,"y":32.666666666666664},{"x":-56.333333333333336,"y":4.666666666666671},{"x":-10.333333333333336,"y":-18.333333333333332},{"x":-6.666666666666667,"y":-28.333333333333336}],"closedStrip":true},"anchor":{"x":0.4970238095238096,"y":0.5155555555555555}},"sample":{"frames":1,"shape":{"type":"rect","top":0,"bottom":384,"left":0,"right":640},"anchor":{"x":0,"y":0}},"BG":{"atlas":"./img/t0.png","frames":0,"shape":{"type":"rect","top":0,"bottom":256,"left":0,"right":256},"anchor":{"x":0,"y":0}},"Asteroid_Medium":{"frames":1,"shape":{"type":"strip","points":[{"x":0.4166666666666667,"y":-19.5},{"x":10.75,"y":-19},{"x":17.416666666666664,"y":-18.083333333333332},{"x":20,"y":-7},{"x":20.833333333333332,"y":8.583333333333332},{"x":12.333333333333334,"y":16.333333333333332},{"x":0.5,"y":21.583333333333332},{"x":-13,"y":17},{"x":-17.416666666666668,"y":4.916666666666667},{"x":-20,"y":-7},{"x":-12.583333333333332,"y":-15.333333333333332},{"x":-7.416666666666666,"y":-20.083333333333336}],"closedStrip":true},"anchor":{"x":0.4883720930232558,"y":0.4883720930232558}},"Laser_Blue":{"frames":1,"shape":{"type":"strip","points":[{"x":0,"y":-27},{"x":4.5,"y":-26},{"x":5.5,"y":-9},{"x":4.166666666666667,"y":27.166666666666668},{"x":-3.1666666666666665,"y":27.333333333333332},{"x":-4,"y":-8},{"x":-4,"y":-25.666666666666668}],"closedStrip":true},"anchor":{"x":0.4444444444444444,"y":0.5}},"EnemyShip":{"frames":1,"shape":{"type":"strip","points":[{"x":0,"y":-42},{"x":19.499999999999996,"y":-34.83333333333333},{"x":25.000000000000004,"y":-35.166666666666664},{"x":51.666666666666664,"y":-1.666666666666666},{"x":37.666666666666664,"y":41.666666666666664},{"x":27.833333333333332,"y":41},{"x":29.499999999999993,"y":29.833333333333336},{"x":13.166666666666671,"y":23.33333333333333},{"x":11.166666666666664,"y":31.83333333333333},{"x":-9.666666666666664,"y":32.66666666666667},{"x":-11.666666666666668,"y":24},{"x":-28.5,"y":28.999999999999996},{"x":-28.5,"y":40.00000000000001},{"x":-37.333333333333336,"y":40.333333333333336},{"x":-51.5,"y":-2.166666666666666},{"x":-24.833333333333332,"y":-35},{"x":-15.833333333333334,"y":-36}],"closedStrip":true},"anchor":{"x":0.49514563106796117,"y":0.5}},"Laser_Red":{"frames":1,"shape":{"type":"strip","points":[{"x":0,"y":-23},{"x":4.083333333333332,"y":-21.166666666666668},{"x":7.000000000000003,"y":-6.583333333333333},{"x":22.583333333333332,"y":-3.4166666666666665},{"x":22.083333333333336,"y":-2.666666666666667},{"x":22.916666666666668,"y":2.9166666666666665},{"x":6.750000000000003,"y":6.666666666666664},{"x":4.416666666666666,"y":21.083333333333332},{"x":-3.583333333333334,"y":21.833333333333332},{"x":-6.416666666666667,"y":6.833333333333333},{"x":-21.583333333333336,"y":5.250000000000002},{"x":-21.25,"y":-4.5},{"x":-6.416666666666667,"y":-6.916666666666666},{"x":-4.666666666666668,"y":-21.75}],"closedStrip":true},"anchor":{"x":0.5,"y":0.5}},"Asteroid_Big":{"frames":1,"shape":{"type":"strip","points":[{"x":0,"y":-42},{"x":24.375,"y":-40},{"x":51,"y":-1.125},{"x":35,"y":33.5},{"x":11.375,"y":30},{"x":-21.875,"y":41.625},{"x":-49.375,"y":9.875},{"x":-44.5,"y":-10.25},{"x":-31.625,"y":-40.625}],"closedStrip":true},"anchor":{"x":0.49504950495049505,"y":0.5}}}][0],
...
var collided2 = ct.place.meet(this, this.x, this.y, 'playership');
if(collided2){
    collided2.kill = true;
    this.kill = true;
    ct.room.score = 0;
    ct.rooms.switch('StartRoom');
}
...
var collided2 = ct.place.meet(this, this.x, this.y, 'Laser_Red');
if(collided2){
    collided2.kill = true;
    this.kill = true;
}
